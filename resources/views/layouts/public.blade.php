...
<head>
    ...
    <title>{{ $title ?? 'Dokument' }} - ROSI</title>
...
<body class="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-400/10">
    ...
    <div class="flex min-h-screen flex-col items-center px-4 py-8 sm:px-6 lg:px-8">
        {{-- Logo --}}
        <a href="/" class="mb-6 flex items-center gap-3 transition-transform hover:scale-105">
