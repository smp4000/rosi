...
/**
 * Chat-Seite im Admin-Panel.
 * Der Admin kann tenant-uebergreifend mit Partnern und Mitarbeitern chatten.
 */
class AdminChatPage extends Page
{
    ...
    protected static ?string $title = 'Admin-Chat';
    ...
    protected string $view = 'filament.pages.admin-chat-page';
